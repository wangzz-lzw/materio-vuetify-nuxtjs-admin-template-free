<template>
    <MdEditor :autoFoldThreshold="autoFoldThreshold" v-model="text" @onChange="changeEditer" @onUploadImg="onUploadImg"
...
const changeEditer = (e: string) => {
    emit("update:modelValue", e)
}

//上传方法
const onUploadImg = async (files: File[], callback: () => void) => {
    console.log(files[0])
    // 获取当前日期
